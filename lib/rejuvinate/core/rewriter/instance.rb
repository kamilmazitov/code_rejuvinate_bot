...
module Rejuvinate::Core
  ...
  #
  # One instance can contain one or many {Rejuvinate::Core::Rewriter::Scope} and {Rejuvinate::Rewriter::Condition}.
  class Rewriter::Instance
    include Rewriter::Helper

    # Initialize an Instance.
    #
    # @param rewriter [Rejuvinate::Core::Rewriter]
    ...
    # It creates a {Rejuvinate::Core::Rewriter::WithinScope} to recursively find matching ast nodes,
    ...
    # It creates a {Rejuvinate::Core::Rewriter::GotoScope} to go to a child node,
    ...
    # It creates a {Rejuvinate::Core::Rewriter::IfExistCondition} to check
    ...
    # It creates a {Rejuvinate::Core::Rewriter::UnlessExistCondition} to check
    ...
    # It creates a {Rejuvinate::Core::Rewriter::IfOnlyExistCondition} to check
    ...
    # @example
    #   # Rejuvinate::Application.config.secret_token = "0447aa931d42918bfb934750bb78257088fb671186b5d1b6f9fddf126fc8a14d34f1d045cefab3900751c3da121a8dd929aec9bafe975f1cabb48232b4002e4e"
    #   # =>
    #   # Rejuvinate::Application.config.secret_token = "0447aa931d42918bfb934750bb78257088fb671186b5d1b6f9fddf126fc8a14d34f1d045cefab3900751c3da121a8dd929aec9bafe975f1cabb48232b4002e4e"
    #   # Rejuvinate::Application.config.secret_key_base = "bf4f3f46924ecd9adcb6515681c78144545bba454420973a274d7021ff946b8ef043a95ca1a15a9d1b75f9fbdf85d1a3afaf22f4e3c2f3f78e24a0a188b581df"
    ...
    #     wrap with: 'module Rejuvinate', and: 'end', newline: true
    #   end
    ...
    # @param action [Rejuvinate::Core::Rewriter::Action] action
    def add_action(action)
      @current_mutation.actions << action.process
    end

    # It creates a {Rejuvinate::Core::Rewriter::Warning} to save warning message.
    # @example
